...
#[test]
fn test_rrt_connect_finds_path_in_so2ss() {
    ...
    let mut planner = RRTConnect::new(0.2, 0.05, &PlannerConfig { seed: Some(0) });
    ...
    println!("RRT-Connect planner test for SO(2) passed!");
}
